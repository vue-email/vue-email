...
<h6 data-id=\\"vue-email-heading\\" style=\\"font-weight:500;padding-top:20;font-size:1rem\\">Heading 6!</h6>
  ...
  it('renders text in the correct format for browsers', () => {
    ...
    expect(actualOutput).toMatchInlineSnapshot(
      '"<!DOCTYPE html PUBLIC \\"-//W3C//DTD XHTML 1.0 Transitional//EN\\" \\"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\\"><div data-id=\\"__vue-email-markdown\\"><strong data-id=\\"vue-email-text\\" style=\\"font-weight:bold\\">This is sample bold text in markdown</strong> and <em data-id=\\"vue-email-text\\" style=\\"font-style:italic\\">this is italic text</em></div>"',
    )
  })
  ...
  it('renders links in the correct format for browsers', () => {
    ...
    expect(actualOutput).toMatchInlineSnapshot(
      '"<!DOCTYPE html PUBLIC \\"-//W3C//DTD XHTML 1.0 Transitional//EN\\" \\"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\\"><div data-id=\\"__vue-email-markdown\\"><p data-id=\\"vue-email-text\\">Link to <a href=\\"https://vue-email.vercel.app/\\" style=\\"color:#007bff;text-decoration:underline;background-color:transparent\\" data-id=\\"vue-email-link\\" target=\\"_blank\\">Vue`-email</a></p></div>"',
    )
  })
