	...
	(function () {
		function MiniSearch2(options) {
			...
			this._options = __assign(__assign(__assign({}, defaultOptions), options), {
				...
				autoSuggestOptions: __assign(__assign({}, defaultAutoSuggestOptions), options.autoSuggestOptions || {}),
			})
					...
					try {
						for (var tokens_1 = ((e_2 = void 0), __values(tokens)), tokens_1_1 = tokens_1.next(); !tokens_1_1.done; tokens_1_1 = tokens_1.next()) {
							...
							if (Array.isArray(processedTerm)) {
								try {
									for (
										var processedTerm_1 = ((e_3 = void 0), __values(processedTerm)), processedTerm_1_1 = processedTerm_1.next();
					...
					try {
						for (var tokens_2 = ((e_6 = void 0), __values(tokens)), tokens_2_1 = tokens_2.next(); !tokens_2_1.done; tokens_2_1 = tokens_2.next()) {
							...
							if (Array.isArray(processedTerm)) {
								try {
									for (
										var processedTerm_2 = ((e_7 = void 0), __values(processedTerm)), processedTerm_2_1 = processedTerm_2.next();
		...
		MiniSearch2.prototype.search = function (query, searchOptions) {
			...
			try {
				for (
					var combinedResults_1 = __values(combinedResults), combinedResults_1_1 = combinedResults_1.next();
				...
				try {
					if (combinedResults_1_1 && !combinedResults_1_1.done && (_a2 = combinedResults_1.return)) _a2.call(combinedResults_1)
				} finally {
					...
					if (this._fieldIds[fieldName] === fieldId) {
						this._options.logger(
							...
							'MiniSearch: document with ID '
								.concat(this._documentIds.get(shortDocumentId), ' has changed before removal: term "')
								.concat(term, '" was not present in field "')
								.concat(fieldName, '". Removing a document after it has changed can corrupt the index!'),
							'version_conflict',
						)
						return
					}
...
var combinators =
	...
	_a)
let defaultBM25params = { k: 1.2, b: 0.7, d: 0.5 }
