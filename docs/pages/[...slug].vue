...
<template>
  <UDocsPage v-if="page" :page="page" :surround="surround as ParsedContent[]">
    ...
    <UButton :to="githubLink" variant="link" icon="i-heroicons-pencil-square" label="Edit this page on GitHub" :padded="false" class="mt-12" />

    <template #footer>
      <Footer />
    </template>
  </UDocsPage>
  <div v-else class="pt-8">Page not found</div>
</template>
