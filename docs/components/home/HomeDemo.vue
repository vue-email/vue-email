...
<template>
  <ULandingGrid ref="section" class="lg:grid-cols-10 lg:gap-8">
    ...
    <div :ref="(el) => (refs[3] = el)" class="col-span-6 flex flex-wrap items-center justify-between gap-1 animate-bottom">
      <UAvatarGroup :max="2">
        <UAvatar
          ...
          loading="lazy"
        />
        <UAvatar src="https://ipx.nuxt.com/s_32x32/gh_avatar/Atinux" srcset="https://ipx.nuxt.com/s_64x64/gh_avatar/Atinux 2x" alt="Atinux" width="40" height="40" loading="lazy" />
        <UAvatar
